...
|----------|--------|---------|
| `/profiles/investment-profiles/` | GET, POST, PATCH, etc. | Includes `is_micro_investor`, `is_creator_influencer`, `audience_reach` |
...
## Frontend
- **InvestorProfileForm**: Checkboxes for “Micro-investor” and “Creator/Influencer”; optional “Audience reach” text when creator is checked. Sends new fields to investment-profiles API.

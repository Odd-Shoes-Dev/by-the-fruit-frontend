...
import { getToken, isAdmin, isApproved, clearAuth, getUserId, getStoredUser } from '../lib/api'
      ...
      >
        ...
        <div className={styles.footerContent}>
          <Link href="/" className={styles.footerBrand}>
            <Image src="/images/logo.png" alt="By The Fruit" width={32} height={32} />
          ...
          <p className={styles.footerDisclaimer}>
            Community access is by approval only. Nothing on this platform constitutes financial advice.
            Membership does not guarantee investment outcomes.
          </p>
          <p className={styles.footerCopy}>© {new Date().getFullYear()} By The Fruit. All rights reserved.</p>
        </div>
      </motion.footer>
    </div>
  )

          ...
          <div className={styles.identityCard}>
            ...
            <div className={styles.identityBody}>
              ...
              <div className={styles.infoList}>
                <InfoRow icon="📍" text={profile.location} />
                <InfoRow icon="📞" text={profile.phone} />
                {business?.website && (
                  <InfoRow icon="🌐" text={
        ...
        <main className={styles.mainCol}>
          ...
          {type === 'founder' && business && (
            ...
            >
              ...
              <div className={styles.detailGrid}>
                {business.city && <InfoRow icon="📍" text={`${business.city}${business.country ? ', ' + business.country : ''}`} />}
                {business.phone && <InfoRow icon="📞" text={business.phone} />}
                {business.email && <InfoRow icon="✉️" text={business.email} />}
                {business.website && (
                  <InfoRow icon="🌐" text={
                    <a href={business.website} target="_blank" rel="noreferrer" className={styles.inlineLink}>
                      {business.website.replace(/^https?:\/\//, '')}
          ...
          {type === 'investor' && investorProfile && (
            ...
            >
              ...
              <div className={styles.detailGrid}>
                {investorProfile.location && <InfoRow icon="📍" text={investorProfile.location} />}
                {investorProfile.phone && <InfoRow icon="📞" text={investorProfile.phone} />}
              </div>
            </motion.section>
          )}

          ...
          {TABS.map(t => (
            <button
              ...
              style={{
                ...
                background: tab === t.key ? 'var(--orange)' : '#fff',
                  ...
                  {pageItems.map(u => (
                    ...
                    >
                      <div style={{ minWidth: 0 }}>
                        ...
                        {u.location && <p className="meta" style={{ margin: '2px 0 0', fontSize: '0.82rem' }}>📍 {u.location}</p>}
                        {u.created_at && (
                      ...
                      <div style={{ display: 'flex', gap: 8, flexShrink: 0, flexWrap: 'wrap' }}>
                        {u.approval_status !== 'approved' && (
                          <button
                            className="btn"
                            style={{ background: '#15803d', minHeight: 36, padding: '6px 16px', fontSize: '0.88rem' }}
                        ...
                        {u.approval_status !== 'rejected' && (
                          <button
                            className="btn"
                            style={{ background: '#fff', color: '#be123c', border: '1.5px solid #fecdd3', minHeight: 36, padding: '6px 16px', fontSize: '0.88rem' }}
                            disabled={!!actionLoading[u.id]}
                        ...
                        <Link href={`/profile/${u.id}`}>
                          <button style={{ padding: '6px 12px', borderRadius: 7, border: '1px solid #e5e7eb', background: '#fff', fontSize: '0.85rem', cursor: 'pointer' }}>
                            View
                          </button>
                        </Link>
                      </div>
                        ...
                        <div className="admin-controls">
                          {(tab === 'messages') && item.email && (
                            <a href={`mailto:${item.email}`}>
                              <button style={{ padding: '5px 10px', borderRadius: 6, border: '1px solid #ddd', background: '#fff', cursor: 'pointer', fontSize: '0.85rem' }}>
                                Reply
                              </button>
                            </a>
                          )}

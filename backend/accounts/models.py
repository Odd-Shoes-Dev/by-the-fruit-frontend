...
class CustomUser(AbstractBaseUser,PermissionsMixin):
    ...
    location = models.CharField(max_length=255, null=True, blank=True, verbose_name='Location (City/Region)')
    postal_code = models.CharField(max_length=20, null=True, blank=True, verbose_name='Postal/ZIP Code')
    ...
    # Profile section visibility (Phase 4)
    ...
    family_visibility = models.CharField(
        max_length=20, choices=VISIBILITY_CHOICES, default=VISIBILITY_EVERYONE, null=True, blank=True
    )
